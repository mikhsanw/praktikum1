    ...
    <div class="m:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="mb-6 border-b pb-4">
                ...
                <p class="text-sm text-gray-500">Perbarui informasi akun dan foto profil Anda.</p>
            </div>
            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-6 mt-2">
                        ...
                        @if ($user->file)
                            <img src="{{ url('/file/' . rawurlencode($user->file->path)) }}" alt="Foto Profil"
                        ...
                        <div class="flex-1">
                            ...
                            @if ($user->file)
                                <a href="{{ url('/file/' . rawurlencode($user->file->path) . '/download') }}"
                ...
                <div class="flex justify-end">
                    <button type="submit"
                        class="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-5 py-2 rounded-lg shadow">
                        Simpan
                    </button>
                </div>
            </form>
